...
import PlaceStoryPlayer from "@/components/PlaceStoryPlayer"
import { getStoryByName } from "@/lib/places-stories"
          ...
          {selectedDestinationDetails && (
            <>
              ...
              <div className="space-y-6">
                ...
                {/* 🎙️ Audio Story Player */}
                {(() => {
                  const storyData = getStoryByName(selectedDestinationDetails.name)
                  return storyData ? (
                    <PlaceStoryPlayer
                      placeName={storyData.name}
