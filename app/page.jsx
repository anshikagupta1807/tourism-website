...
export default function HomePage() {
  ...
  <Link href="/admin">
    <Button
      variant="outline"
      size="sm"
      className="flex items-center gap-2 hover:bg-green-600 hover:text-white transition-colors bg-transparent border-green-600 text-green-700"
    >
      ...
      <footer className="border-t py-16 px-4 bg-nature-gradient">
        <div className="container mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  <Mail className="h-4 w-4" />
                  <span>anshika98976@gmail.com</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="h-4 w-4" />
          ...
          <div className="border-t pt-8 text-center text-sm text-muted-foreground">
            <p>
              © 2025 Government of Jharkhand. All rights reserved. | Promoting sustainable tourism and cultural
              preservation.
            </p>
          </div>
        </div>
